...
export default {
  ...
  description: 'Setup a fitting local development environment at the current project directory. This tool should not be used on its own! Only in context of a running bugfix process.',
  paramsSchema: {
